    ...
    <body>
        ...
        <header>
            ...
            <a href="#inicio" class="logo"> 
                <span>Formulario</span> de Estudiantes
            </a>
        ...
        <section class="inicio" id="inicio">       
            <div class="image">
                <img src="Recursos/imagenes/cora.png" alt="">
            </div>

            <div class="content">
                <h3>NUESTRA <span></span> MISION</span></h3>
                <p>MISION: Buscamos dar el mejor registro y control a los estudiantes de su salud por medio de nuestro formulario.</p>
                <a href="#Estudiante" class="boton">SIGUIENTE</a>
            </div>
        ...
        <section class="Estudiante" id="Estudiante">
            ...
            <div class="image">
                <img src="Recursos/imagenes/salud.jpg" alt="">
            ...
            <div class="contendor">
                ...
                <h1 class="heading">REGISTRO DE DATOS</h1>
